...
export function useHistoriaBuilder({
    ...
    function seleccionarCIE_10(code) {
        ...
        historiaStore.Formulario.Analisis.Diagnosticos.at(-1).codigo = code.code
    }

    function seleccionarVadecum(item) {
        historiaStore.Formulario.Analisis.Plan_manejo_medicamentos.at(-1).medicamento = item.producto
        historiaStore.Formulario.Analisis.Plan_manejo_medicamentos.at(-1).codigo = item.expedientecum + item.consecutivocum
        historiaStore.Formulario.Analisis.Plan_manejo_medicamentos.at(-1).dosis = item.viaadministracion
    }
    ...
    if (varView.tipoConsulta?.plantilla === 'Terapia') {
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            Define como se espera que el paciente alcance los objetivos terapéuticos.
                                        </p>
                                    </div>
                            ...
                            <div class="px-5 py-4 bg-linear-to-r from-green-500/10 to-green-500/5 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            Describe de manera clara la evolución del paciente durante la sesión.
                                        </p>
                                    </div>
        ...
        builder
                        ...
                        <div class="rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800">
                            ...
                            <div class="px-5 py-4 bg-linear-to-r from-blue-500/10 to-blue-500/5 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="w-11 h-11 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                                        <i class="fa-solid fa-comment text-blue-600 text-lg"></i>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            Describa el motivo principal de la consulta, incluyendo síntomas, duración y cualquier factor relevante.
                                        </p>
                                    </div>
            ...
            .addCampo({
                ...
                id: 'motivo',
                name: 'motivo',
                placeholder: 'El paciente presenta dolor hace 3 días, acompañado de náuseas y fiebre...',
                tamaño: 'w-full col-span-2'
            })
                        ...
                        <div class="rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800">
                            ...
                            <div class="px-5 py-4 bg-linear-to-r from-green-500/10 to-green-500/5 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="w-11 h-11 rounded-xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                                        <i class="fa-solid fa-notes-medical text-green-600 text-lg"></i>
                                    </div>
            ...
            .addCampo({
                ...
                placeholder: 'incluye cambios en síntomas, respuesta al tratamiento y cualquier observación relevante',
                tamaño: 'w-full col-span-2'
            })
            // --- Diagnosticos ---
            .addCampo({
        ...
        builder
            ...
            .addCampo({
                ...
                id: 'motivo',
                name: 'motivo',
                placeholder: 'Se requiere una evaluación social para determinar el impacto...',
                tamaño: 'w-full col-span-2'
            })
                        ...
                        <div class="rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800">
                            ...
                            <div class="px-5 py-4 bg-linear-to-r from-green-500/10 to-green-500/5 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="w-11 h-11 rounded-xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                                        <i class="fa-solid fa-comment text-green-600 text-lg"></i>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            Describa el análisis y tratamiento para la consulta.
                                        </p>
                                    </div>
            ...
            .addCampo({
                ...
                id: 'analisis',
                name: 'analisis',
                placeholder: 'El paciente presenta mejoría en su estado clínico...',
                tamaño: 'w-full col-span-2',
                minlength: 10
            })

            .nuevaSeccion('Diagnosticos y plan')
            .addCampo({
                component: 'GroupCampos',
                labelGroup: 'Diagnosticos',
                buttons: [{ icon: 'fa-solid fa-plus', label: 'Agregar', color: 'bg-blue-500', addItem: { descripcion: '', codigo: '', id_paciente: id_paciente } }],
        ...
        builder
            ...
            .addCampo({
                ...
                value: [],
                campos: [
                    { name: 'descripcion', id: 'antecedente', typeCampo: 'Input', placeholder: 'Antecedente', tamaño: 'w-full', label: 'Antecedente' },
                    {
                        name: 'tipo',
                        id: 'tipoAntecedente',
                        typeCampo: 'Select',
        ...
        if (puedePostAnalisis.value) {
            ...
            builder
                .addCampo({
                    ...
                    text: '<i class="fa-solid fa-comment text-green-600 mr-1"></i>Observación',
                    tamaño: 'w-full md:col-span-2'
                })
                .addCampo({
                    component: 'Input',
            ...
            builder.addCampo({
                ...
                text: `
                        <div class="rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800">
                            ...
                            <div class="px-5 py-4 bg-linear-to-r from-orange-500/10 to-orange-500/5 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900 dark:text-white">
                                            No tienes permisos para diagnosticar
                                        </p>

                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            Pulsa en "siguiente" para registrar o pide que te otorguen el permiso.
                                        </p>
                                    </div>
